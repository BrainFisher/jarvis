...
class CustomUser(AbstractUser):
    ...
    storage_limit = models.BigIntegerField(
        default=50 * 1024 * 1024)  # Ліміт за замовчуванням 50 МБ
...
class File(models.Model):
    ...
    task = models.ForeignKey(
        Task, on_delete=models.CASCADE, null=True, blank=True, related_name='files')
    note = models.ForeignKey(
        Note, on_delete=models.CASCADE, null=True, blank=True, related_name='files')
